 ...
 *
 * Sanitized render of the cached patch-notes summary at
 * .claude/knowledge/poe2/cached/0.5-announcement.md (gitignored, internal).
 * Content pass 2026-05-22 against the official 0.5 patch notes (forum thread
 * 3932540, published 2026-05-21). Summary + attribution only — never a
 * verbatim repost of GGG's patch notes.
 *
    ...
    <div className="max-w-3xl mx-auto space-y-10 pb-12">
      ...
      <div className="space-y-3">
        ...
        <h1 className="text-3xl font-bold text-zinc-100 leading-tight">
          Runes of Aldur — Path of Exile 2 patch 0.5, explained
        </h1>
        <p className="text-sm text-zinc-500">
          Updated 2026-05-22 from the{' '}
          <a href={PATCH_NOTES_URL} target="_blank" rel="noopener noreferrer" className="text-cyan-400/80 hover:text-cyan-300">
            official 0.5 patch notes
          </a>{' '}
          (published 2026-05-21). A plain-language digest with sources — not a copy of GGG's full notes.
          Launches <strong className="text-zinc-300">{LAUNCH_DATE}</strong>.
        </p>
      </div>
      ...
      <Section title="Headline facts">
        <table className="w-full text-sm">
          <tbody className="divide-y divide-white/[0.04]">
            ...
            <Row label="Full patch notes" value="Published 2026-05-21 04:00 UTC (official forum)" />
            <Row label="Pre-1.0 status" value="Final major Early Access patch before 1.0 (still slated for 2026)" />
            <Row
              label="Total content scale"
              value={`50+ hours of new endgame content · 5 storylines · 15 bosses (4 Pinnacle) · 40+ new uniques`}
            />
          </tbody>
        </table>
      </Section>
      ...
      <Section title="Atlas tree — completely rebuilt">
        ...
        <p>
          ...
          offer ascendancy-style trees on the atlas itself. Each Master has a{' '}
          <strong className="text-zinc-100">12-node sub-tree of which only 4 can be selected at a time</strong>
          — but all three Masters can be active simultaneously, and you can change
          the 4-of-12 selection at any time with no respec cost. Each is unlocked
          by its own questline:
        </p>
        <ul className="list-disc pl-5 space-y-1">
          <li><strong>Jado's Spycraft</strong> — unlocked by clearing an anomaly map near the start. Options include more Rares, more Uniques, or an extra modifier on corrupted Waystones.</li>
          <li><strong>Hilda's Hunting</strong> — unlocked at Hilda's Campsite. Bossing-focused, e.g. a chance to upgrade Map Bosses to Powerful Map Bosses.</li>
          <li><strong>Doryani's Science</strong> — unlocked by clearing a corruption nexus. Node-level bonuses not yet fully enumerated.</li>
        </ul>
        <p>
          Endgame restructured around a fortress at the atlas centre — its maps
          grant the atlas passive points, and clearing them all gives enough to
          fully allocate the tree. The fortress houses the returning Arbiter of
          Ash and an unnamed deeper pinnacle boss at its core.
        </p>
        <Callout color="amber">
      ...
      <Section title="Runic Ward — a new defensive resource">
        <p>
          A new defence layer alongside health, mana, and energy shield. It{' '}
          <strong className="text-zinc-100">kicks in once you reach 1 life</strong>,
          letting you keep surviving while the Ward takes damage, and it{' '}
          <strong className="text-zinc-100">regenerates independently of your life</strong>.
          Added to gear through Verisium Runeforging (unlocked in Act 1).
        </p>
        <ul className="list-disc pl-5 space-y-1">
          <li>Armours <strong>below item level 55</strong> gain Runic Ward with no downside.</li>
          <li>Armours <strong>at or above item level 55</strong> trade some of their regular base defences for it.</li>
          <li>Runeforging can either <em>add</em> Runic Ward to an item or <em>replace</em> its defensive mods for a large amount of Ward.</li>
        </ul>
      </Section>

      <Section title="Kalguuran skill gems">
        <p>
          A new family of <strong className="text-zinc-100">21 skill gems + 8 support gems</strong>{' '}
          ships with 0.5. They:
        </p>
        <ul className="list-disc pl-5 space-y-1">
          <li><strong>Consume Runic Ward instead of mana.</strong></li>
          <li><strong>Have no attribute or weapon requirements</strong> — colorless and any-build accessible, on any class. A meaningful break from PoE 2's typical attribute gating.</li>
        </ul>
        <p className="text-xs text-zinc-500">
          The confirmed roster includes Frostflame Nova, Conductive Runes, Runic
          Reprieve, Skyfall, Triskelion Cascade, and Voltaic Barrier, among
          others. (Two early data-mined names — "Runic Infusion" and "Concussive
          Runes" — didn't survive verbatim into the final list.)
        </p>
      </Section>
      ...
      <Section title="Crafting expansion">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li><strong>Liquid Emotions</strong> — the existing amulet-anointing currency (3 emotions enchant a passive-tree notable onto your amulet) can now <em>also</em> craft modifiers on Jewels.</li>
          <li>
            <strong>Timelost Jewels</strong> — a new jewel class crafted with the new emotion families:{' '}
            <strong>10 Ancient Emotions</strong> (Atlas-tree-gated) craft them,{' '}
            <strong>3 Potent Emotions</strong> (from Delirious map bosses) craft off-pool mods on normal Jewels, and{' '}
            <strong>3 Ancient Potent Emotions</strong> craft off-pool mods on Timelost Jewels. Potent Emotions can also instill off-tree notables onto amulets.
          </li>
      ...
      <Section title="Quality of life">
        <ul className="list-disc pl-5 space-y-1">
          <li>
            ...
            item suggestions, level notes) that import directly in-client. The{' '}
            <code>.build</code> JSON format is now publicly documented in GGG's
            developer docs; the client reads these files but can't author them
            in-game yet.
          </li>
      ...
      {/* ═══ What the patch notes resolved ═══ */}
      <Section title="What the patch notes settled">
        <p>
          Open questions from the announcement era, now answered by the 0.5
          patch notes:
        </p>
        <ul className="list-disc pl-5 space-y-1">
          <li>
            <strong className="text-zinc-200">Waystones — changed, not overhauled.</strong>{' '}
            11 modifiers removed from the pool, ~18 moved between prefix and
            suffix, and bonus values retuned (more Monster Effectiveness, Pack
            Size, Rarity, etc.). The T1–T16 tier structure is intact. Waystones
            now also need to be identified before use.
          </li>
          <li>
            <strong className="text-zinc-200">Spirit, weapon sets, and charms — unchanged at the system level.</strong>{' '}
            No reworks; only a few item/keystone tweaks (e.g. Soul Mantle now
            grants +75 Spirit, Eternal Rage must be active in both weapon sets).
          </li>
        </ul>
        <p className="text-xs text-zinc-500">
          Still not addressed in these notes: a PoE 1-style Currency Exchange,
          auction-house-equivalent trade improvements, and any Trial of the
          Sekhemas / Trial of Chaos changes.
        </p>
      </Section>
      ...
      <Section title="Sources">
        <p className="text-xs">
          Primary source is GGG's official 0.5 patch notes, cross-checked
          against Maxroll's patch-notes coverage and poe2db data-mining. Earlier
          announcement recaps retained for the reveal-livestream details.
        </p>
        <div className="bg-zinc-900/60 border border-white/[0.06] rounded-lg divide-y divide-white/[0.04]">
          <SourceRow name="Official — Content Update 0.5.0 patch notes" href={PATCH_NOTES_URL} />
          <SourceRow name="Official — PoE 2 developer docs (.build format)" href="https://www.pathofexile.com/developer/docs/game" />
          <SourceRow name="Maxroll PoE 2 — 0.5.0 patch notes" href="https://maxroll.gg/poe2/news/0-5-0-patch-notes-return-of-the-ancients" />
          <SourceRow name="poe2db.tw — data-mined 0.5 content" href="https://poe2db.tw/us/" />
