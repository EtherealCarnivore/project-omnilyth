      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="text-center space-y-3">
            ...
            {/* Explicit flex row: these are siblings on ONE line, so the parent's
                space-y-3 gives them no horizontal gap and its margin-top knocks
                them out of vertical alignment instead. items-stretch equalises
                the heights — only one of the two carries an icon. */}
            <div className="flex flex-wrap items-stretch justify-center gap-2">
              {currentPlaybook && (
                <button
                  onClick={handleImportFromPlaybook}
                  className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-emerald-500/10 border border-emerald-400/20 text-emerald-300 hover:bg-emerald-500/20 transition-all"
                >
              ...
              <Link
                to="/leveling/planner"
                className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-amber-500/10 border border-amber-400/20 text-amber-300 hover:bg-amber-500/20 transition-all"
              >
                Create Plan
              </Link>
            </div>
