...
export const scarabs = {
 ...
 "Abyss Scarab of Edifice": {
   ...
   description: "Abysses that do not lead to Abyssal Depths lead to a Stygian Spire; Abysses spawn Hoards as they travel",
 },
 ...
 "Abyss Scarab of Profound Depth": {
   ...
   description: "Monsters from Abysses have increased Difficulty and Reward for each prior Pit",
 },
 "Ambush Scarab": {
   name: "Ambush Scarab",
   regex: "u'",
 ...
 "Ambush Scarab of Containment": {
   ...
   description: "Area contains many additional Strongboxes; inhabitants are lying in ambush",
 },
 ...
 "Ambush Scarab of Potency": {
   ...
   description: "75% Increased effect of Explicit Modifiers on Strongboxes",
 },
 "Anarchy Scarab": {
   name: "Anarchy Scarab",
   regex: "it'",
 ...
 "Anarchy Scarab of Gigantification": {
   ...
   description: "Wild Rogue Exiles have a 30% chance to be replaced with a Rogue Giant",
 },
 "Anarchy Scarab of Partnership": {
   ...
   description: "Wild Rogue Exiles have a 50% chance to appear in pairs",
 },
 "Bestiary Scarab": {
 ...
 "Betrayal Scarab of Reinforcements": {
   ...
   description: "Syndicate Members have 50% increased chance to be accompanied by reinforcements",
 },
 "Betrayal Scarab of the Allflame": {
   ...
   description: "75% Increased number of Monster Packs Substituted by Allflame Embers",
 },
 "Beyond Scarab": {
   name: "Beyond Scarab",
   regex: "wal",
 ...
 "Beyond Scarab of Haemophilia": {
   ...
   description: "Beyond Portals have 50% increased Merging Radius",
 },
 "Beyond Scarab of Resurgence": {
   ...
   description: "Beyond Bosses are enraged on low life, drop 100% increased Tainted Currency, 30% increased chance to spawn Unique Boss",
 },
 "Beyond Scarab of the Invasion": {
   ...
   description: "Rare and Unique Monsters slain create 8 to 12 additional Beyond Portals",
 },
 "Blight Scarab": {
   name: "Blight Scarab",
   regex: "ndr",
 ...
 "Blight Scarab of Blooming": {
   ...
   description: "Blight Encounters have up to 3 additional Unique Bosses; T14+ Blighted Maps drop as Blight-Ravaged instead",
 },
 "Blight Scarab of Invigoration": {
   ...
   description: "Each Empowering Tower grants Blighted Monsters in range increased Difficulty and Reward",
 },
 "Blight Scarab of the Blightheart": {
   ...
   description: "Blight Encounters have one Blighted Chest, spawn many more waves; Chests grow larger and more rewarding",
 },
 "Breach Scarab": {
   name: "Breach Scarab",
   regex: "er fa",
 ...
 "Breach Scarab of Lordship": {
   ...
   description: "Breaches each contain a Breachlord",
 },
 "Breach Scarab of Resonant Cascade": {
   ...
   description: "Breaches open and close 10% faster for each Breach already opened; increased Difficulty and Reward",
 },
 "Breach Scarab of Snares": {
   ...
   description: "Breaches have 3 to 5 additional Clasped Hands guarded by a rare Breach Monster",
 },
 "Breach Scarab of Splintering": {
   ...
   description: "Breach Monsters and Clasped Hands drop 50% more Breach Splinters",
 },
 ...
 "Cartography Scarab of Escalation": {
   ...
   description: "10% increased Maps found for each Map Modifier affecting Area",
 },
 ...
 "Cartography Scarab of the Multitude": {
   ...
   description: "Area contains 8 to 12 additional packs which drop 300% increased Maps",
 },
 "Delirium Scarab": {
 ...
 "Delirium Scarab of Mania": {
   ...
   description: "Delirium Reward Meters fill 100% faster; Delirium increases 50% faster with distance",
 },
 "Delirium Scarab of Neuroses": {
   ...
   description: "Delirium Encounters contain all Unique Delirium Bosses (Tier 11+ only)",
 },
 "Delirium Scarab of Paranoia": {
   ...
   description: "Delirium Encounters generate 2 additional Reward types",
 },
 "Divination Scarab of Pilfering": {
   ...
   description: "Divination Cards are stolen by Final Map Boss; Boss duplicates all stolen cards when defeated",
 },
 "Divination Scarab of Plenty": {
   ...
   description: "Area contains 6 to 10 additional Divination Touched Magic Monster packs",
 },
 "Divination Scarab of The Cloister": {
   ...
   description: "Area contains 8 to 12 additional packs of Doedre's Devoted with 1% chance to drop Stacked Deck",
 },
 "Domination Scarab": {
 ...
 "Domination Scarab of Terrors": {
   ...
   description: "Shrines are guarded by an Atlas Boss with Final Map Boss modifiers",
 },
 "Essence Scarab": {
   name: "Essence Scarab",
   regex: "saf",
 ...
 "Essence Scarab of Adaptation": {
   ...
   description: "Imprisoned Monsters grant a random Essence Modifier to another Imprisoned Monster; increased Difficulty and Reward per modifier",
 },
 ...
 "Essence Scarab of Calcification": {
   ...
   description: "Rare monsters that are natural inhabitants are imprisoned by Essences",
 },
 "Essence Scarab of Stability": {
   ...
   description: "Remnant of Corruption can only result in upgrading or transforming Essences",
 },
 "Expedition Scarab": {
 ...
 "Expedition Scarab of Archaeology": {
   ...
   description: "Remnants in Expedition Encounters have 2 additional Suffixes and Prefixes",
 },
 "Expedition Scarab of Runefinding": {
   ...
   description: "Expedition Encounters have 100% increased number of Runic Monster Markers",
 },
 "Expedition Scarab of Verisium Powder": {
   ...
   description: "Expedition Encounters have 50% increased Explosives and 80% increased Explosive Radius",
 },
 "Harbinger Scarab": {
 ...
 "Harbinger Scarab of Obelisks": {
   ...
   description: "Harbingers spawn Empowered Obelisks that drop Currency Shards when defeated",
 },
 "Harbinger Scarab of Regency": {
   ...
   description: "Harbingers have a 50% chance to be replaced by a powerful Harbinger Boss",
 },
 "Harbinger Scarab of Warhoards": {
   ...
   description: "Currency shards dropped by Harbingers are duplicated",
 },
 "Harvest Scarab": {
   name: "Harvest Scarab",
   regex: "val",
 ...
 "Harvest Scarab of Cornucopia": {
   ...
   description: "Sacred Grove contains up to 1 additional Tier 4 seed of each type",
 },
 "Harvest Scarab of Doubling": {
   ...
   description: "Lifeforce dropped by Harvest Monsters is duplicated; Harvest Monsters have 100% more Life",
 },
 ...
 "Horned Scarab of Glittering": {
   ...
   description: "Players gain increased Item Rarity per Monster slain, up to 400%, decaying over time",
 },
 "Horned Scarab of Nemeses": {
   ...
   description: "Rare Monsters have 2 additional Modifiers",
 },
 "Horned Scarab of Pandemonium": {
   ...
   description: "Monster packs have a 15% chance to be replaced by a random Atlas Boss",
 },
 ...
 "Horned Scarab of Tradition": {
   ...
   description: "All Rare and Unique Monsters have dropped items transformed by a Reward Modifier",
 },
 "Incursion Scarab": {
 ...
 "Incursion Scarab of Champions": {
   ...
   description: "Incursions have 35% chance for all Monsters to be Magic; 15% increased Pack Size",
 },
 ...
 "Incursion Scarab of Timelines": {
   ...
   description: "Final Architect drops an Itemised Temple with randomised room tiers",
 },
 "Influencing Scarab of Conversion": {
   ...
   description: "T14+ Maps may drop as Shaper/Elder Guardian, Conqueror, or Unique Synthesised Maps",
 },
 "Influencing Scarab of Hordes": {
   ...
   description: "Influenced Monster Packs have 40% increased Pack Size",
 },
 ...
 "Kalguuran Scarab of Guarded Riches": {
   ...
   description: "Monsters guarding Ore Deposits are at least Magic",
 },
 "Kalguuran Scarab of Refinement": {
   ...
   description: "Ore Deposits grant Smelted Bars instead of Marking Ore",
 },
 "Legion Scarab": {
   name: "Legion Scarab",
   regex: "arr",
 ...
 "Legion Scarab of Command": {
   ...
   description: "Legion Factions are accompanied by a General",
 },
 "Legion Scarab of Eternal Conflict": {
   ...
   description: "Legion Monsters can be broken out of Stasis multiple times with increased Difficulty and Reward",
 },
 "Legion Scarab of Officers": {
   ...
   description: "Legion Factions have 5 additional Sergeants",
 },
 "Ritual Scarab of Abundance": {
   ...
   description: "Rituals offer 100% increased Favours",
 },
 "Ritual Scarab of Selectiveness": {
   ...
   description: "Rerolling Favours has no cost the first 2 times; 1 additional reroll allowed",
 },
 "Ritual Scarab of Wisps": {
   ...
   description: "Ritual Altars spawn a Wildwood Wisp; Wisps grant 100% increased Tribute",
 },
 ...
 "Scarab of Bisection": {
   ...
   description: "Select Nullify Prefixes or Nullify Suffixes on the Map Device",
 },
 "Scarab of Divinity": {
   ...
   description: "Up to 2 additional Rare Monsters will be Pantheon-Touched",
 },
 ...
 "Scarab of Stability": {
   ...
   description: "Portals have a 50% chance to not be consumed on use",
 },
 "Scarab of Wisps": {
   ...
   description: "Monsters have a chance to be Empowered by 2000 Wildwood Wisps",
 },
 "Sulphite Scarab": {
 ...
 "Sulphite Scarab of Fumes": {
   ...
   description: "Sulphite releases Enraging Fumes; affected Monsters have 50% increased Item Quantity",
 },
 "Titanic Scarab": {
   name: "Titanic Scarab",
   regex: "nam",
   ...
   description: "Unique Monsters have 1% increased stats per 1% increased Pack Size",
 },
 "Titanic Scarab of Legend": {
   ...
   description: "Unique Monsters have 2 additional Monster Modifiers",
 },
 "Titanic Scarab of Treasures": {
   ...
   description: "Unique Monsters have an additional Reward and 30% increased Toughness",
 },
 "Torment Scarab": {
   name: "Torment Scarab",
   regex: "rim",
   ...
   description: "Area is haunted by 3 additional Tormented Spirits; 25% chance to be set free on kill",
 },
 "Torment Scarab of Peculiarity": {
   ...
   description: "Tormented Spirits are replaced with unusual variants",
 },
 "Torment Scarab of Possession": {
   ...
   description: "Rare Monsters have a quarter chance to be Possessed by up to 1 Tormented Spirit",
 },
 "Ultimatum Scarab": {
 ...
 "Ultimatum Scarab of Bribing": {
   ...
   description: "Ultimatum Monsters grant 150% increased Experience; rewards as though 2 additional Rounds completed",
 },
 "Ultimatum Scarab of Catalysing": {
   ...
   description: "Ultimatum Encounters will only offer Catalysts as Rewards",
 },
 "Ultimatum Scarab of Dueling": {
   ...
   description: "Ultimatum Encounters will always lead to a Unique Boss if possible",
 },
 "Ultimatum Scarab of Inscription": {
   ...
   description: "Ultimatum rewards offering Catalysts will offer Inscribed Ultimatums instead",
 },
};
