...
export default function LevelingSidebar({ open, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        id="app-sidebar"
        aria-label="Leveling navigation"
        className={`
          fixed lg:static inset-y-0 left-0 z-50 w-64
          bg-zinc-950/95 backdrop-blur-md border-r border-white/[0.06]
          transform motion-safe:transition-transform motion-safe:duration-300 ease-in-out
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-b border-white/[0.06]">
            <button
              ...
              className="w-full min-h-11 flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-zinc-400 hover:text-zinc-200 hover:bg-white/[0.04] transition-colors"
            >
          ...
          <div className="p-4 border-b border-white/[0.06]">
            <div className="space-y-2">
              ...
              <div className="text-xs text-zinc-400">
                Mode: <span className="text-zinc-300">{mode === 'fresh' ? 'Fresh Start' : 'Alt Character'}</span>
              </div>
            </div>
          </div>
